...
---|---|---|---|---
v2022-07-17 00:54:29|2022-07-17 00:54:29|auto|@12774|Created by smart-doc
...
**Request-example:**
```
curl -X POST -i http://{{server}}/user/register --data 'name=ramona.abernathy&password=fr8cdf'
```
**Response-fields:**
...
**Request-example:**
```
curl -X POST -i http://{{server}}/user/qq_bot --data 'number=698'
```
**Response-fields:**
...
**Request-example:**
```
curl -X POST -i http://{{server}}/user/qqGroupWhitelist --data 'number=98'
```
**Response-fields:**
...
**Request-example:**
```
curl -X DELETE -i http://{{server}}/user/qqGroupWhitelist/130
```
**Response-fields:**
...
**Request-example:**
```
curl -X DELETE -i http://{{server}}/user/messageCallback/546
```
**Response-fields:**
